...
/// `despesa` por conta, mesmo espírito do cálculo em memória de
/// `get_portfolio_positions` (`commands/transaction.rs`). Função pura
/// (sem I/O) para ficar testável isoladamente.
fn compute_balances(
...
pub async fn list_bank_accounts(
    ...
    let balances = compute_balances(&transactions);
