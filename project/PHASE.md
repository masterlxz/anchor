...
**Nenhuma fatia restante depende mais de pendência cross-repo** — as duas que bloqueavam (rota `/sign-message` com transporte cross-device, e `/truthid/v1/pin`) foram resolvidas do lado do TruthID entre 2026-07-16 e 07-17. 8.1 e 8.2 fechados na Sessão 31; 8.3 com código pronto e pin real validado na Sessão 32, mas com a suspeita de rede errada (ver nota acima) como bloqueio pra fechar de vez — **próxima sessão começa por aí**, antes de seguir pra 8.4/8.5.
